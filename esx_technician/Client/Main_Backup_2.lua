...
--]]
RegisterNetEvent("startQuest", function()
	if ESX ~= nil then
		if ESX.PlayerData.job.name == "technician" and CurrentJob ~= nil then
					...
					if IsControlJustPressed(1, 51) then
						...
						TriggerEvent("datacrack:start", 3, function(output)
							if output == true then
								...
								Hacking.ReturnType = "EXIT"
								TriggerEvent("finishedHacking","EXIT")
							end
						end)
					end
				end
