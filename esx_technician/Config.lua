...
Config = {
    ...
    TranslationList = { -- List of all translation which you car choose
        ["IT"] = {
            ...
            ["GARAGE_PROBLEM"] = "~r~ Qualcosa è andato storto! Il veicolo non può essere estratto!",
            ...
            ["MENU_CREATED"] = "~g~ Ti è stata assegnata una riparazione!",
            ["MENU_CANCEL"] = "Annulla riparazione corrente",
            ["MENU_CANCELED"] = "~g~ Riparazione annullata con successo!",
            ["MENU_ALREADY"] = "~r~ Hai già una riparazione attiva! Devi prima annullare quella.",
